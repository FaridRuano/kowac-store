...
export default function InventoryCatalogControls({
  categories = [],
  currentCategory = "",
  currentPage = 1,
  currentQuery = "",
  ...
  return (
    <div className={`admin-product-list-toolbar ${isPending ? "admin-product-list-toolbar--loading" : ""}`}>
      <div className={`admin-product-list-controls ${hasFilters ? "admin-product-list-controls--with-actions" : ""}`}>
        <label>
          <div className="admin-product-list-controls__search">
            ...
            <input
              aria-label="Buscar inventario por nombre"
              name="q"
      ...
      <div className="admin-product-list-pagination" aria-label="Paginación de inventario">
        <button
          type="button"
